...
A beautiful, Reduced ad‑free YouTube experience for macOS Ventura and later. Built with SwiftUI + WKWebView(a website wrapper with enhanced features), which feels like a native Apple app .
## ✨ Features
